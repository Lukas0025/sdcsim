...
python3 ../stats.py ./../build/sdcsim ./../sdcasm/inc.sdcasm             --strands $strandsC --strands_range $strandsRange --strands_step $strandsStep -t $timeC --time_range $timeRange --time_step $timeStep -T 50 -r 100 -s $samples -i $iterations -p inc.png
